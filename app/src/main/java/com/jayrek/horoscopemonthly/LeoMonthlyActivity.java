 ...
 */
public class LeoMonthlyActivity extends Activity {
    TextView sign, date, desc, backSign;
    ImageView img_sign;

    private String finalUrl = "http://www.findyourfate.com/rss/monthly-horoscope.asp?sign=Leo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initVar();
        Intent i = getIntent();
        String leoChar = i.getStringExtra("leo");
        sign.setText(leoChar);
