 ...
 */
public class ScorpioMonthlyActivity extends Activity{
    TextView sign, date, desc, backSign;
    ImageView img_sign;

    private String finalUrl = "http://www.findyourfate.com/rss/monthly-horoscope.asp?sign=Scorpio";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initVar();
        Intent i = getIntent();
        String scorpioChar = i.getStringExtra("scorpio");
        sign.setText(scorpioChar);
