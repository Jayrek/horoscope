 ...
 */
public class GeminiMonthlyActivity extends Activity {
    TextView sign, date, desc, backSign;
    ImageView img_sign;

    private String finalUrl = "http://www.findyourfate.com/rss/monthly-horoscope.asp?sign=Gemini";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initVar();
        Intent i = getIntent();
        String geminiChar = i.getStringExtra("gemini");
        sign.setText(geminiChar);
