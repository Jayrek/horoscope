 ...
 */
public class VirgoMonthlyActivity extends Activity {
    TextView sign, date, desc, backSign;
    ImageView img_sign;

    private String finalUrl = "http://www.findyourfate.com/rss/monthly-horoscope.asp?sign=Virgo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initVar();
        Intent i = getIntent();
        String virgoChar = i.getStringExtra("virgo");
        sign.setText(virgoChar);
