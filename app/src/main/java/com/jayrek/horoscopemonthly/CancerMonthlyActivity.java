 ...
 */
public class CancerMonthlyActivity extends Activity {
    TextView sign, date, desc, backSign;
    ImageView img_sign;

    private String finalUrl = "http://www.findyourfate.com/rss/monthly-horoscope.asp?sign=Cancer";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initVar();
        Intent i = getIntent();
        String cancerChar = i.getStringExtra("cancer");
        sign.setText(cancerChar);
