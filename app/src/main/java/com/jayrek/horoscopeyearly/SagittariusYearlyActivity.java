 ...
 */
public class SagittariusYearlyActivity extends Activity{

    TextView sign, date, desc, backSign;
    ImageView img_sign;

    private String finalUrl = "http://www.findyourfate.com/rss/yearly-horoscope.asp?sign=Sagittarius";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initVar();
        Intent i = getIntent();
        String sagittariusChar = i.getStringExtra("sagittarius");
        sign.setText(sagittariusChar);
